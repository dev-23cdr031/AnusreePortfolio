...
const recipientEmail = process.env.CONTACT_TO_EMAIL ?? 'anusreedharmalingam26@gamil.com'
      ...
      return NextResponse.json(
        {
          ...
          error: 'Contact email delivery is not configured yet. Add RESEND_API_KEY to send messages to anusreedharmalingam26@gamil.com.',
        },
        { status: 500 },
      )
    }
