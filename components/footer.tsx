...
export function Footer() {
  ...
  const footerLinks = {
    ...
    Connect: [
      { label: 'GitHub', href: 'https://github.com/Anusree26' },
      { label: 'LinkedIn', href: 'https://www.linkedin.com/in/anu-sree-974ab6370/' },
      { label: 'Instagram', href: 'https://www.instagram.com/_anusree_26_?igsh=MWQzZHpqZnRnZTB5Ng==' },
      { label: 'Email', href: 'mailto:anusreedharmalingam26@gamil.com' },
    ],
  }
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div className="space-y-4 animate-fade-in-left">
              <Link href="/" className="flex items-center gap-2 group w-fit hover:-translate-y-1 transition-transform duration-300">
                <span className="text-lg font-bold text-foreground group-hover:text-primary transition-colors duration-300 animate-text-glow">ANUSREE D</span>
              </Link>
              ...
              <div className="flex gap-3 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
                {[
                  { href: 'https://github.com/Anusree26', Icon: Github, label: 'GitHub' },
                  { href: 'https://www.linkedin.com/in/anu-sree-974ab6370/', Icon: Linkedin, label: 'LinkedIn' },
                  { href: 'mailto:anusreedharmalingam26@gamil.com', Icon: Mail, label: 'Email' },
                ].map((social, idx) => (
                  <a
                    key={idx}
                    href={social.href}
        ...
        <div className="py-8 animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-sm text-muted-foreground hover:text-foreground transition-colors duration-300">
              &copy; {currentYear} Anusree D. All rights reserved.
            </p>
