              ...
              <PremiumCard delay={0.25} accent="blue">
                <div className="grid sm:grid-cols-2 gap-3">
                  {[
                    ...
                    { label: 'Personal Mail ID', value: 'anusreedharmalingam26@gamil.com' },
                    { label: 'HSC Percentage', value: '92.5%' },
                    { label: 'SSLC Percentage', value: 'Pass' },
                    { label: 'College', value: 'KONGU ENGINEERING COLLEGE' },
                    { label: 'Current CGPA', value: '8.46 CGPA (5th sem)' },
